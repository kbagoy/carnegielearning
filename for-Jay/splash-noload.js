...
(lib.splashnoload = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// Astronaut
	this.instance = new lib.Astronaut();
	this.instance.setTransform(369.7,219.1,0.034,0.034,0,0,0,0,138);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:137.2,scaleX:1,scaleY:1,x:330.7,y:158.1},30).wait(1));

	// Moon
	this.instance_1 = new lib.Moon();
	this.instance_1.setTransform(371.1,244.4,0.038,0.038,0,0,0,0,612.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:611.6,scaleX:1.1,scaleY:1.1,y:891.5},30).wait(1));

	// Stars
	this.instance_2 = new lib.Tween4("synched",0);
	this.instance_2.setTransform(386,202.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:0.55,scaleY:0.55},30).wait(1));
