...
(lib.moduleendnotext = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.setTransform(847.5,632.1,1,1,0,0,0,72.5,144);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(37).to({_off:false},0).wait(1).to({x:828.6,y:625.9},0).wait(1).to({x:809.8,y:619.7},0).wait(1).to({x:790.9,y:613.4},0).wait(1).to({x:772.1,y:607.2},0).wait(1).to({x:740,y:582.3},0).wait(1).to({x:707.9,y:557.4},0).wait(1).to({x:675.9,y:532.6},0).wait(1).to({x:643.8,y:507.7},0).wait(1).to({x:611.8,y:482.8},0).wait(1).to({x:579.7,y:457.9},0).wait(1).to({x:547.6,y:433},0).wait(1).to({x:515.6,y:408.1},0).wait(1).to({x:483.5,y:383.3},0).wait(1).to({x:451.5,y:358.4},0).wait(1).to({x:419.4,y:333.5},0).wait(1).to({x:387.4,y:308.6},0).wait(22));

	// md-flag
	this.instance_2 = new lib.mdflag2();
	this.instance_2.setTransform(676.8,622.7,1,1,0,0,0,70,158);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(37).to({_off:false},0).wait(1).to({x:658,y:616.5},0).wait(1).to({x:639.1,y:610.3},0).wait(1).to({x:620.3,y:604},0).wait(1).to({x:601.4,y:597.8},0).wait(1).to({x:569.3,y:572.9},0).wait(1).to({x:537.3,y:548},0).wait(1).to({x:505.2,y:523.2},0).wait(1).to({x:473.2,y:498.3},0).wait(1).to({x:441.1,y:473.4},0).wait(1).to({x:409.1,y:448.5},0).wait(1).to({x:377,y:423.6},0).wait(1).to({x:344.9,y:398.7},0).wait(1).to({x:312.9,y:373.9},0).wait(1).to({x:280.8,y:349},0).wait(1).to({x:248.8,y:324.1},0).wait(1).to({x:216.7,y:299.2},0).wait(22));

	// moon
	this.instance_3 = new lib.mdmoonlg();
	this.instance_3.setTransform(819,909.2,0.838,0.838);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(37).to({_off:false},0).wait(1).to({x:792.7,y:889},0).wait(1).to({x:766.5,y:868.8},0).wait(1).to({x:740.2,y:848.5},0).wait(1).to({x:714,y:828.3},0).wait(1).to({x:687.7,y:808.1},0).wait(1).to({x:661.5,y:787.9},0).wait(1).to({x:635.2,y:767.7},0).wait(1).to({x:609,y:747.5},0).wait(1).to({x:582.7,y:727.2},0).wait(1).to({x:556.4,y:707},0).wait(1).to({x:530.2,y:686.8},0).wait(1).to({x:503.9,y:666.6},0).wait(1).to({x:477.7,y:646.4},0).wait(1).to({x:451.4,y:626.2},0).wait(1).to({x:425.2,y:605.9},0).wait(1).to({x:398.9,y:585.7},0).wait(22));

	// planetfield
	this.instance_4 = new lib.mdplanetfield();
	this.instance_4.setTransform(385.2,236);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(42).to({regX:13,regY:-62.1,x:401.5,y:177.2},0).wait(1).to({x:404.8,y:180.5},0).wait(1).to({x:408.2,y:183.9},0).wait(1).to({x:411.5,y:187.2},0).wait(1).to({x:414.8,y:190.5},0).wait(1).to({x:418.2,y:193.9},0).wait(1).to({x:421.5,y:197.2},0).wait(1).to({x:424.8,y:200.5},0).wait(1).to({x:428.2,y:203.9},0).wait(1).to({x:431.5,y:207.2},0).wait(1).to({x:434.8,y:210.5},0).wait(1).to({x:438.2,y:213.9},0).wait(22));

	// tiny-stars
	this.instance_5 = new lib.mdtinystars();
	this.instance_5.setTransform(307.6,211.4,1.007,1.007,0,0,0,480.2,270.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(42).to({regY:269.5,x:310.9,y:213.6},0).wait(1).to({x:314.3,y:217},0).wait(1).to({x:317.6,y:220.3},0).wait(1).to({x:320.9,y:223.6},0).wait(1).to({x:324.3,y:227},0).wait(1).to({x:327.6,y:230.3},0).wait(1).to({x:330.9,y:233.6},0).wait(1).to({x:334.3,y:237},0).wait(1).to({x:337.6,y:240.3},0).wait(1).to({x:340.9,y:243.6},0).wait(1).to({x:344.3,y:247},0).wait(1).to({x:347.6,y:250.3},0).wait(22));
