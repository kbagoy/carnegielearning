...
(lib.sploadingfill = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[]},1).wait(7));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},23).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[]},18).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.astrosplash1).wait(1).to({regX:-16.9,regY:129.4,scaleX:0.07,scaleY:0.07,x:367.1,y:148.6},0).wait(1).to({scaleX:0.11,scaleY:0.11,x:365,y:149},0).wait(1).to({scaleX:0.14,scaleY:0.14,x:363,y:149.6},0).wait(1).to({scaleX:0.18,scaleY:0.18,x:360.9,y:150},0).wait(1).to({scaleX:0.22,scaleY:0.22,x:358.9,y:150.5},0).wait(1).to({scaleX:0.25,scaleY:0.25,x:356.8,y:151.1},0).wait(1).to({scaleX:0.29,scaleY:0.29,x:354.8,y:151.5},0).wait(1).to({scaleX:0.33,scaleY:0.33,x:352.8,y:152},0).wait(1).to({scaleX:0.36,scaleY:0.36,x:350.7,y:152.5},0).wait(1).to({scaleX:0.4,scaleY:0.4,x:348.7,y:153},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:346.6,y:153.5},0).wait(1).to({scaleX:0.47,scaleY:0.47,x:344.6,y:154},0).wait(1).to({scaleX:0.51,scaleY:0.51,x:342.6,y:154.5},0).wait(1).to({scaleX:0.55,scaleY:0.55,x:340.5,y:155},0).wait(1).to({scaleX:0.58,scaleY:0.58,x:338.4,y:155.5},0).wait(1).to({scaleX:0.62,scaleY:0.62,x:336.4,y:156},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:334.3,y:156.5},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:332.3,y:157},0).wait(1).to({scaleX:0.73,scaleY:0.73,x:330.3,y:157.5},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:328.2,y:158},0).wait(1).to({scaleX:0.8,scaleY:0.8,x:326.2,y:158.5},0).wait(1).to({scaleX:0.84,scaleY:0.84,x:324.2,y:159},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:322.1,y:159.5},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:320.1,y:160},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:318,y:160.5},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:316,y:161},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:313.9,y:161.5},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:311.9,y:162},0).wait(1));

	// Moon
	this.moon1 = new lib.spmoon();
	this.moon1.setTransform(371.1,173.6,0.038,0.038,0,0,0,0,612.6);

	this.timeline.addTween(cjs.Tween.get(this.moon1).wait(1).to({regY:611.6,scaleX:0.08,scaleY:0.08,y:201.1},0).wait(1).to({scaleX:0.12,scaleY:0.12,y:228.7},0).wait(1).to({scaleX:0.16,scaleY:0.16,y:256.3},0).wait(1).to({scaleX:0.2,scaleY:0.2,y:283.9},0).wait(1).to({scaleX:0.24,scaleY:0.24,y:311.4},0).wait(1).to({scaleX:0.28,scaleY:0.28,y:339},0).wait(1).to({scaleX:0.32,scaleY:0.32,y:366.6},0).wait(1).to({scaleX:0.36,scaleY:0.36,y:394.2},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:421.8},0).wait(1).to({scaleX:0.44,scaleY:0.44,y:449.3},0).wait(1).to({scaleX:0.48,scaleY:0.48,y:476.9},0).wait(1).to({scaleX:0.52,scaleY:0.52,y:504.5},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:532},0).wait(1).to({scaleX:0.6,scaleY:0.6,y:559.6},0).wait(1).to({scaleX:0.64,scaleY:0.64,y:587.2},0).wait(1).to({scaleX:0.68,scaleY:0.68,y:614.8},0).wait(1).to({scaleX:0.72,scaleY:0.72,y:642.4},0).wait(1).to({scaleX:0.76,scaleY:0.76,y:669.9},0).wait(1).to({scaleX:0.8,scaleY:0.8,y:697.5},0).wait(1).to({scaleX:0.84,scaleY:0.84,y:725.1},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:752.7},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:780.3},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:807.8},0).wait(1).to({scaleX:1,scaleY:1,y:835.4},0).wait(1).to({scaleX:1.04,scaleY:1.04,y:863},0).wait(1).to({scaleX:1.08,scaleY:1.08,y:890.6},0).wait(1).to({scaleX:1.12,scaleY:1.12,y:918.2},0).wait(1).to({scaleX:1.16,scaleY:1.16,y:945.7},0).wait(1));

	// Stars
	this.instance_3 = new lib.spstartween("synched",0);
	this.instance_3.setTransform(386,202.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:0.55,scaleY:0.55},28).wait(1));

	// tinystars
	this.instance_4 = new lib.sptinystars();
	this.instance_4.setTransform(382.2,196.4,1,1,0,0,0,480.2,270.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regY:269.5,scaleX:1,scaleY:1,x:382.3,y:195.2},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:195.1},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:382.4},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:382.5},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:382.6},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:195},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:382.7},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:382.8},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,x:382.9,y:194.9},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93,x:383},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:194.8},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:383.1},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:383.2},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:383.3},0).wait(1).to({scaleX:0.89,scaleY:0.89},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:383.4,y:194.7},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.87,scaleY:0.87,x:383.5},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:194.6},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:383.6},0).wait(1).to({scaleX:0.86,scaleY:0.86},0).wait(1).to({scaleX:0.85,scaleY:0.85,x:383.7},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.b1}]}).wait(29));
